    ...
    return ( <
        div style = {
          ...
          mostrarBorrador && ( <
            ...
            <
            h5 className = "modal-title fw-bold text-dark" > 📝Borrador Disponible <
            /h5> <
            /div> <
        ...
        div className = "d-flex align-items-center justify-content-md-end flex-wrap gap-3" > {
          /* Estado de conexión */ } <
        div className = {
          `badge ${isOnline ? 'bg-success' : 'bg-danger'} mb-1 mb-md-0`
        } > {
        ...
        div className = "d-flex align-items-center justify-content-center rounded bg-success"
        style = {
          {
            minWidth: '150px',
            height: '35px'
        ...
        {
          /* FOTO DE USUARIO */ } <
        div className = "rounded-circle overflow-hidden mb-1 mb-md-0 border border-success"
        style = {
          {
            width: '40px',
            height: '40px'
...

        {
          busqueda.length >= 2 && productos.length > 0 && ( <
            div className = "position-absolute bg-white shadow rounded mt-2 p-2 z-3"
            style = {
              {
                top: '100%',
                left: 0,
            ...
            tbody > {
              productos.map((item) => ( <
                ...
                onClick = {
                  () => setImagenModal(item.imagen || IMAGEN_POR_DEFECTO)
                } >
                Ver Imagen <
                /button> <
        ...
        button className = "btn btn-success rounded-pill d-flex align-items-center justify-content-center d-md-inline-flex"
        onClick = {
        ...
        div className = "col-12 col-md-4 mb-3 mb-md-0 ps-0" > {
          !esPedidoValido() && pedido.length > 0 && ( <
            div className = "alert alert-warning mb-0 h-20"
            role = "alert" >
            <
            ...
            ul className = "mb-0 ps-3" > {
              !cliente.trim() && < li > Ingrese el nombre del cliente < /li>} {
                ...
                onChange = {
                  (e) => guardarObservacionGeneral(e.target.value)
                }
                style = {
                  {
                ...
                disabled = {
                  ...
                  button
                className = {
                  `btn fw-semibold px-4 py-2 ${puedeEnviar() ? 'btn-success' : 'btn-outline-success'}`
                }
                onClick = {
                  enviarPedido
                }
                ...
                className = "btn btn-success d-flex align-items-center gap-2 px-4 py-2 shadow rounded-pill" > 📋 < span className = "nav-label" > Catálogo < /span> <
                  /Link> <
                  button className = "btn btn-success d-flex align-items-center gap-2 px-4 py-2 shadow rounded-pill" > ➕ < span className = "fw-semibold text-white" > Pedido < /span> <
                  /button> <
                  Link to = '/ordenes'
